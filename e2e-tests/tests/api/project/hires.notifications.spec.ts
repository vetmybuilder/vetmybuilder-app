...
test.describe("Hire notifications", () => {
  ...
  test("homeowner receives a hire_accepted notification when the tradesman accepts", async ({
    request,
    runtime,
    projectApi,
    hireApi,
    ...
    const notification = await notificationsApi.findLatestByType("hire_accepted");
