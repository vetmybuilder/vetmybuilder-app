...
const EMULATOR_USERS = [
  ...
  {
    // Local admin account. The matching `user_roles` row (uid → 'admin') is
    // already in MySQL, so we only need to ensure the Firebase emulator user
    // exists with this email/password on every startup.
