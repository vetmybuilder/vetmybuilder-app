              ...
              <>
                ...
                <form onSubmit={onSubmit} className="space-y-5">
                  ...
                  <button
                    ...
                    className={`w-full inline-flex items-center justify-center gap-2 rounded-full px-8 py-4 text-base font-bold text-white shadow-lg transition-colors disabled:cursor-not-allowed ${busy ? "bg-zinc-400" : "bg-red-500 shadow-red-500/25 hover:bg-red-600 active:scale-95 disabled:opacity-50"}`}
                  >
