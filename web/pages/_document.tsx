    ...
    <Html lang="en">
      <Head>
        {/* Establish connection to Unsplash CDN early so background images
            ...
            <img> request fires */}
        {/* Google Fonts — Sora (headings/body) + Indie Flower (accent) */}
        <link rel="preconnect" href="https://fonts.googleapis.com" />
        <link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="anonymous" />
        <link href="https://fonts.googleapis.com/css2?family=Sora:wght@400;600;800&family=Indie+Flower&display=swap" rel="stylesheet" />
