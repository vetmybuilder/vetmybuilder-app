...
/**
 * In the SQLite world this created the tradesmen_flags table at boot.
 * In the MySQL world the schema is managed by mysql_schema.sql, so this
 * becomes a no-op to avoid running SQLite-specific DDL.
 */
module.exports = function ensureAdminTables(_db) {
  // Schema now lives in MySQL migrations / mysql_schema.sql
  // Nothing to do here.
};
